...
//		twoArrayContent.compareArrays(arr1, arr2); //same
//		twoArrayContent.compareArrays(arr1, arr3); //Not same
//		twoArrayContent.compareArr(arr1, arr2); // same
//		twoArrayContent.compareArr(arr1, arr3); //not same
		twoArrayContent.checkArrayContent(arr1, arr3); // important - same
	}
	...
	public void checkArrayContent(int[] arr1, int[] arr3) {
		...
		/*
		 * for (java.util.Map.Entry<Integer, Integer> e : map.entrySet()) { if
		 * (e.getValue() >= 1) { System.out.println(e.getKey() + " -- " + e.getValue());
		 * } } System.out.println("--------------------"); for
		 * (java.util.Map.Entry<Integer, Integer> e1 : map1.entrySet()) { if
		 * (e1.getValue() >= 1) { System.out.println(e1.getKey() + " -- " +
		 * e1.getValue()); } }
		 */
		boolean flag = true;
		for (java.util.Map.Entry<Integer, Integer> e : map.entrySet()) {
			for (java.util.Map.Entry<Integer, Integer> e1 : map1.entrySet()) {
				if (e.getKey().equals(e1.getKey())) {  // check this logic. Key should be checked one by one
